<System.ComponentModel.RunInstaller(True)> Partial Class KTWEServiceInstaller
    ...
    Private Sub InitializeComponent()
        ...
        'KTWEServiceInst
        '
        Me.KTWEServiceInst.Description = "KTWE RFID Reader Service"
        Me.KTWEServiceInst.DisplayName = "KTWEReaderService"
        Me.KTWEServiceInst.ServiceName = "KTWEReaderService"
        '
