...
public enum MSGTYPE
    ...
    public class EPCINFO{
        ...
        public String GetEPC()
        {
            ...
            for (int x = 0; x < EPCSIZE && x <16; x++) sb.Append(TAGDATA[x].ToString("X2"));
            sEPC = sb.ToString();
            return sEPC;
        }
    } ;
    ...
    public class MSG_BLOCK_READ
    {
        ...
        public String GetEPC()
        {
            String sEPC;
            StringBuilder sb = new StringBuilder();
            for (int x = 0; x < EPCSIZE && x< 16 ; x++) sb.Append(EPC[x].ToString("X2"));
            sEPC = sb.ToString();
            return sEPC;
        }
        ...
        public String GetBANK()
        {
            String sEPC;
            StringBuilder sb = new StringBuilder();
            for (int x = 0; x < LEN && x<64; x++) sb.Append(DATA[x].ToString("X2"));
            sEPC = sb.ToString();
            return sEPC;
        }
